...
public class DataGameChallenge {

    private static DataGameChallenge datagameChallenge;

    static {
        datagameChallenge = new DataGameChallenge();
    }

    public static DataGameChallenge getDatagameChallenge() {
        return datagameChallenge;
    }
