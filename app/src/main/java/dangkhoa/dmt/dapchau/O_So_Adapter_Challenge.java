...
public class O_So_Adapter_Challenge extends ArrayAdapter<Integer> {

    private Context ct;
    private ArrayList<Integer> arr;
    private ArrayList<Integer> loai;

    public O_So_Adapter_Challenge(@NonNull Context context, int resource, @NonNull List<Integer> objects) {
    ...
    public void notifyDataSetChanged() {
        arr = DataGameChallenge.getDatagameChallenge().getArrSo();
        loai = DataGameChallenge.getDatagameChallenge().getLoai();
