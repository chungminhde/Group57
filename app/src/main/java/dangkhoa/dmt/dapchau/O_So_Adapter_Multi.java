...
public class O_So_Adapter_Multi extends ArrayAdapter<Integer> {

    private Context ct;
    private ArrayList<Integer> arr;
    private ArrayList<Integer> loai;

    public O_So_Adapter_Multi(@NonNull Context context, int resource, @NonNull List<Integer> objects) {
